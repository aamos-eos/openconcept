...
from openconcept.propulsion import QuadParallelHybridElectricPropulsionSystem
...
class QuadParallelHybridModel(Group):
    """
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "propmodel",
            QuadParallelHybridElectricPropulsionSystem(num_nodes=nn),
...
class QuadHybridAnalysisGroup(Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "analysis",
            BasicMission(num_nodes=nn, aircraft_model=QuadParallelHybridModel),
            promotes_inputs=["*"],
            promotes_outputs=["*"],
        )
...
def configure_problem():
    prob = Problem()
    prob.model = QuadHybridAnalysisGroup()
